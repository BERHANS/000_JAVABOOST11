...
public class Tesr {
	...
	OfisCalisani ofisCalisani = new OfisCalisani("berhan", "sezer");
	
	System.out.println(ofisCalisani.getAd()+ ofisCalisani.getSoyad());
	
		ofisCalisani.setUnvan(ofisCalisani.getMaas());
		System.out.println(ofisCalisani.getUnvan());

		Personel muhendis3 = new Muhendis("ali cabbar","gırnata");
